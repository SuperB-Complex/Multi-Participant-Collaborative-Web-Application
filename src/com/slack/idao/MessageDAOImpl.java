...
import com.slack.pojo.Message;
import com.slack.dao.MessageDAO;
...
public class MessageDAOImpl extends BaseDAOImpl implements MessageDAO  {
    ...
    public Message findById(com.slack.pojo.MessageId id) {
        log.debug("getting Message instance with id: " + id);
        try {
            Message instance = (Message) getCurrentSession()
                    .get("com.slack.dao.Message", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Message instance) {
        ...
        try {
            List results = getCurrentSession().createCriteria("com.slack.dao.Message") .add(Example.create(instance)).list();
    ...
    public Message merge(Message detachedInstance) {
        ...
        try {
            Message result = (Message) getCurrentSession()
